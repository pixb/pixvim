...
M.moved = {
  ...
  ui = {
    ...
    foldexpr = { "PixVim.treesitter.foldexpr", stacktrace = false },
    fg = {
...
function M.decorate(name, mod)
  ...
  return setmetatable(mod, {
    __call = function(_, ...)
      ...
      PixVim.deprecate("PixVim." .. name, to)
    ...
    __index = function(_, k)
      if M.moved[name][k] then
        ...
        PixVim.deprecate("PixVim." .. name .. "." .. k, to, {
...
function M.lazygit()
  PixVim.deprecate("PixVim.lazygit", "Snacks.lazygit")
...
function M.toggle()
  PixVim.deprecate("PixVim.toggle", "Snacks.toggle")
  return {
    map = function() end,
    wrap = function()
      return {}
